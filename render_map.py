...
<head>
    ...
    <title>GeoJSON Map Viewer - OpenLayers</title>
...
<body>
    <header>
        <h1>🗺️ GeoJSON Map Viewer</h1>
        <p class="subtitle">Interactive map powered by OpenLayers</p>
    </header>
...
def main():
    ...
    geojson_path = Path(__file__).parent / 'data' / 'colossus.json'
    ...
    output_path = Path(__file__).parent / 'colossus_map.html'
